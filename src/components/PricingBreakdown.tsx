    ...
    >
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h4 className="font-serif-harvest font-bold text-neutral-900 text-sm">Automated Transparent Economics</h4>
            <p className="text-xs text-neutral-500 font-sans">Verified fair-trade breakdown per unit sold</p>
          </div>
        </div>
        <span className="px-2.5 py-1 text-xs font-mono font-bold rounded-full bg-emerald-100 text-emerald-800 border border-emerald-200">
          88% Direct to Grower
        </span>
      </div>
      ...
      <div className="space-y-2 py-2 border-y border-neutral-150 text-xs">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <span className="font-bold text-emerald-700 text-sm font-mono">₹{farmerShare.toFixed(2)}</span>
            <span className="text-neutral-400 text-[11px] ml-1.5 font-mono">(88.0%)</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <span className="font-medium text-neutral-800 font-mono">₹{logisticsShare.toFixed(2)}</span>
            <span className="text-neutral-400 text-[11px] ml-1.5 font-mono">(7.0%)</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <span className="font-medium text-neutral-800 font-mono">₹{platformShare.toFixed(2)}</span>
            <span className="text-neutral-400 text-[11px] ml-1.5 font-mono">(5.0%)</span>
          </div>
        </div>
      </div>
